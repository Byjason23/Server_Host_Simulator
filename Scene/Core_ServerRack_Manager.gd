...
func setserverupgrade(dataserver):
	...
	print(Server_Upgrade.Server_Name)
	updateRack()
...
func _on_core_upgrade_ui_upgrade_buttonpressed(data_server_rack):
	setserverupgrade(data_server_rack)


func _on_save_marker_load_core_rack(data_Server_Rack):
	setserverupgrade(data_Server_Rack)


func _on_upgrade_ui_upgrade_core_rack(Rack_Data: Variant) -> void:
